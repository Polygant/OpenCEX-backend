...
@shared_task
def cache_tenzura_sat_per_byte(logger=None):
    """Calculates tenzura sat/b value using mempool info and caches it"""
    logger = logger or log
    config = 'http://{username}:{password}@{host}:{port}'.format(**settings.NODES_CONFIG['tenz'])
    ...
    sat_per_byte_cache.set('tenzura', s_p_b) 