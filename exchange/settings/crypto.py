...
TRX_NET_FEE = env('TRX_NET_FEE', 3_000_000)  # 3 TRX
TRC20_FEE_LIMIT = env('TRC20_FEE_LIMIT', 30_000_000)  # 30 TRX
TRX_BLOCK_GENERATION_TIME = env('TRX_BLOCK_GENERATION_TIME', 3)
TRX_TRC20_ACCUMULATION_PERIOD = env('TRX_TRC20_ACCUMULATION_PERIOD', 1 * 60.0)
